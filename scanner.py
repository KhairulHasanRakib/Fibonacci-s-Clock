...
def main():
    ...
    try:
        ...
        print(f"Error: Unable to resolve hostname {target}: {e}")
        sys.exit(1)

    # Add a pretty banner starting the scan
    print("-" * 50)
    ...
    # Add a pretty banner ending the scan
    print("-" * 50)
    print(f"Scanning target {target_ip}")
    print(f"Time end: {datetime.now()}")
    print(f"Total open ports: {len(open_ports)}")  # Print total open ports
    print("-" * 50)
    print("\nScan completed!")
